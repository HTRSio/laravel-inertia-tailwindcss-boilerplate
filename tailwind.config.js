...
module.exports = {
  ...
  theme: {
    screens: settingsScreens, fontSize: settingsFontSizes, extend: {
      fontFamily: {
  ...
  plugins: [require('@tailwindcss/forms'), require('@tailwindcss/line-clamp'), require('@tailwindcss/aspect-ratio'), require('@tailwindcss/typography'), require('tailwindcss-debug-screens')],
};
